...
export const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <motion.div 
      ...
      className="bg-white/95 dark:bg-zinc-900/95 rounded-3xl border border-zinc-200/90 dark:border-zinc-800/90 shadow-[0_4px_24px_-6px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.3)] p-4 sm:p-5 mb-6 backdrop-blur-md transition-colors"
    >
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex-1 group">
            ...
            <input
              ...
              placeholder="Search headword, English meaning, example, or forms..."
              className="w-full pl-10 pr-9 py-2.5 bg-zinc-50/80 dark:bg-zinc-800/80 border border-zinc-200/80 dark:border-zinc-700 rounded-2xl text-sm placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:bg-white dark:focus:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all text-zinc-800 dark:text-zinc-100"
            />
            {searchQuery && (
              <motion.button
          ...
          <motion.button
            ...
            className="flex items-center gap-2 px-3.5 py-2.5 bg-zinc-100/90 dark:bg-zinc-800 hover:bg-zinc-200/70 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-200 font-semibold text-xs rounded-2xl transition-all shrink-0 border border-zinc-200/80 dark:border-zinc-700 shadow-2xs"
          >
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-zinc-100 dark:border-zinc-800">
          ...
          <div className="flex flex-wrap items-center gap-1.5 p-1 bg-zinc-100/80 dark:bg-zinc-950/80 rounded-2xl border border-zinc-200/70 dark:border-zinc-800">
            {levels.map((lvl) => {
